...
<html lang="en">
    ...
    <body class="auth-body-bg">
                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3">
                          ...
                          @csrf
                                ...
                                Enter Your <strong>E-mail</strong> Forgot your password? <strong>No problem</strong>. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.
        ...
        <script src="{{asset('backend/ssets/libs/simplebar/simplebar.min.js')}}a"></script>
